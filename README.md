...
- [] L'utilisateur peut ** se connecter à Twitter ** en utilisant la connexion OAuth
- [] L'utilisateur peut ** afficher les tweets à partir de sa chronologie personnelle **
...
- [] L'utilisateur peut actualiser la chronologie des tweets en tirant vers le bas pour actualiser

Les fonctionnalités ** facultatives ** suivantes sont implémentées:

- [] L'utilisateur peut voir plus de tweets en défilant avec une pagination infinie
...
- [] L'utilisateur peut ** cliquer sur un lien dans le corps d'un tweet ** dans la vue détaillée du tweet. Le clic lancera le navigateur Web avec la page appropriée ouverte.
- [] L'utilisateur peut afficher la liste des abonnés / suiveurs à travers n'importe quel profil qu'ils consultent.
